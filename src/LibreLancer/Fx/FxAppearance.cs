...
namespace LibreLancer.Fx
{
    public class FxAppearance : FxNode
    {
        ...
        public virtual void Draw(ParticleEffectInstance instance, AppearanceReference node, int nodeIdx,
            ...
            out Quaternion rotate)
        {
            ...
            while (pr is { IsAttachmentNode: false })
            {
                if (pr.Node.Transform is { HasTransform: true, Animates: true })
                {
                    idx++;
