...
namespace LibreLancer.Utf.Dfm
{
    public class DfmMesh
    {
        ...
        private ElementBuffer elementBuffer = null!;
                    ...
                    case "face_groups":
                        ...
                        foreach (Node faceGroupNode in faceGroupsNode.Children)
                        {
                            ...
                            else if (faceGroupNode.Name.StartsWith("group", StringComparison.OrdinalIgnoreCase))
                            {
                                ...
                                throw new Exception(
                                    "Invalid node in " + faceGroupsNode.Name + ": " + faceGroupNode.Name);
                        }
                        ...
                        foreach (LeafNode geometrySubNode in node.Children)
                        {
                            switch (geometrySubNode.Name.ToLowerInvariant())
                            {
                                ...
                                case "uv_default_list":
                                    ...
                                    break;
                                default:
                                    throw new Exception("Invalid node in " + node.Name + ": " + geometrySubNode.Name);
                            }
                        }
