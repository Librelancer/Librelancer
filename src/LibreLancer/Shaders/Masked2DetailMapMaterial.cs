...
namespace LibreLancer.Shaders
{
    ...
    public class Masked2DetailMapMaterial
    {
        ...
        internal static void Compile(LibreLancer.Graphics.RenderContext device, string sourceBundle)
        {
            ...
            {
                variants[0] = ShaderVariables.Compile(device, sourceBundle.Substring(251766, 1545), sourceBundle.Substring(314410, 7181));
                variants[1] = ShaderVariables.Compile(device, sourceBundle.Substring(266917, 4472), sourceBundle.Substring(324375, 3125));
            }
            else
            {
                variants[0] = ShaderVariables.Compile(device, sourceBundle.Substring(246231, 1204), sourceBundle.Substring(309834, 4576));
                variants[1] = ShaderVariables.Compile(device, sourceBundle.Substring(260247, 4131), sourceBundle.Substring(321591, 2784));
            }
        }
    }
}
