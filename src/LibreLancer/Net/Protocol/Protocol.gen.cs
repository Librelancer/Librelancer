// AUTOGENERATED CODE
// Generated: 20210829 08:02:42 UTC
// Method count: 23
...
namespace LibreLancer.Net
{
    public interface IClientPlayer
    {
        ...
        void BaseEnter(string _base, NetShipLoadout ship, string[] rtcs, NewsArticle[] news, SoldGood[] goods);
    ...
    public partial class RemoteClientPlayer : IClientPlayer
    {
        ...
        public void BaseEnter(string _base, NetShipLoadout ship, string[] rtcs, NewsArticle[] news, SoldGood[] goods)
        {
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_SpawnPlayer _4: {
                    player.SpawnPlayer(_4.system,_4.position,_4.orientation,_4.ship);
                    return true;
                }
                case ClientPacket_SpawnSolar _5: {
                    player.SpawnSolar(_5.solars);
                    return true;
                }
                case ClientPacket_OnConsoleMessage _6: {
                    player.OnConsoleMessage(_6.text);
                    return true;
                }
                case ClientPacket_SpawnDebris _7: {
                    player.SpawnDebris(_7.id,_7.archetype,_7.part,_7.position,_7.orientation,_7.mass);
                    return true;
                }
                case ClientPacket_BaseEnter _8: {
                    player.BaseEnter(_8._base,_8.ship,_8.rtcs,_8.news,_8.goods);
                    return true;
                }
                case ClientPacket_UpdateRTCs _9: {
                    player.UpdateRTCs(_9.rtcs);
                    return true;
                }
                case ClientPacket_DespawnObject _10: {
                    player.DespawnObject(_10.id);
                    return true;
                }
                case ClientPacket_PlaySound _11: {
                    player.PlaySound(_11.sound);
                    return true;
                }
                case ClientPacket_PlayMusic _12: {
                    player.PlayMusic(_12.music);
                    return true;
                }
                case ClientPacket_DestroyPart _13: {
                    player.DestroyPart(_13.idtype,_13.id,_13.part);
                    return true;
                }
                case ClientPacket_RunMissionDialog _14: {
                    player.RunMissionDialog(_14.lines);
                    return true;
                }
            }
            return false;
