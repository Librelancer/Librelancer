// AUTOGENERATED CODE
// Generated: 20221022 08:17:16 UTC
// Method count: 54
...
namespace LibreLancer.Net
{
    ...
    {
        public const string PROTOCOL_HASH = "OMLQ0SK6/q2c0Fi62PbXwQ";
        ...
        public static async Task<bool> HandleServerPacket(IPacket pkt, IServerPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ServerPacket_Respawn _20: {
                    player.Respawn();
                    return true;
                }
                case ServerPacket_ChatMessage _21: {
                    player.ChatMessage(_21.category,_21.message);
                    return true;
                }
                case ServerPacket_EnterFormation _22: {
                    player.EnterFormation(_22.ship);
                    return true;
                }
                case ServerPacket_LeaveFormation _23: {
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_ReceiveChatMessage _28: {
                    player.ReceiveChatMessage(_28.category,_28.player,_28.message);
                    return true;
                }
                case ClientPacket_PopupOpen _29: {
                    player.PopupOpen(_29.title,_29.contents,_29.id);
                    return true;
                }
                case ClientPacket_OnPlayerJoin _30: {
                    player.OnPlayerJoin(_30.id,_30.name);
                    return true;
                }
                case ClientPacket_OnPlayerLeave _31: {
                    player.OnPlayerLeave(_31.id,_31.name);
                    return true;
                }
            }
            return false;
