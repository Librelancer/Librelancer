// AUTOGENERATED CODE
// Generated: 20220621 08:05:17 UTC
// Method count: 50
...
namespace LibreLancer.Net
{
    ...
    {
        public const string PROTOCOL_HASH = "m8S10mZnq9jBHWEJgikHPw";
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_BaseEnter _12: {
                    player.BaseEnter(_12._base,_12.objective,_12.rtcs,_12.news,_12.goods,_12.ships);
                    return true;
                }
                ...
                case ClientPacket_ObjectiveUpdate _14: {
                    player.ObjectiveUpdate(_14.objective);
                    return true;
                }
                ...
                case ClientPacket_TradelaneActivate _24: {
                    player.TradelaneActivate(_24.id,_24.left);
                    return true;
                }
                case ClientPacket_TradelaneDeactivate _25: {
                    player.TradelaneDeactivate(_25.id,_25.left);
                    return true;
                }
                case ClientPacket_ReceiveChatMessage _26: {
                    player.ReceiveChatMessage(_26.category,_26.player,_26.message);
                    return true;
                }
                case ClientPacket_PopupOpen _27: {
                    player.PopupOpen(_27.title,_27.contents,_27.id);
                    return true;
                }
                case ClientPacket_OnPlayerJoin _28: {
                    player.OnPlayerJoin(_28.id,_28.name);
                    return true;
                }
                case ClientPacket_OnPlayerLeave _29: {
                    player.OnPlayerLeave(_29.id,_29.name);
                    return true;
                }
            }
            return false;
