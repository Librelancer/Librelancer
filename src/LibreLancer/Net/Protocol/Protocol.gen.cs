// AUTOGENERATED CODE
// Generated: 20231013 05:49:26 UTC
// Method count: 63
...
namespace LibreLancer.Net.Protocol
{
    public interface IClientPlayer
    {
        ...
        void SpawnPlayer(string system, NetObjective objective, Vector3 position, Quaternion orientation, uint tick);
    ...
    public partial class RemoteClientPlayer : IClientPlayer
    {
        ...
        public void SpawnPlayer(string system, NetObjective objective, Vector3 position, Quaternion orientation, uint tick)
        {
    ...
    {
        public const string PROTOCOL_HASH = "FLiRQTF2HJP4godrsCb3/Q";
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_SpawnPlayer _4: {
                    player.SpawnPlayer(_4.system,_4.objective,_4.position,_4.orientation,_4.tick);
                    return true;
                }
