// AUTOGENERATED CODE
// Generated: 20220919 10:12:08 UTC
// Method count: 51
...
namespace LibreLancer.Net
{
    ...
    {
        public const string PROTOCOL_HASH = "3U1hiNa+Xshgvq0R/q5/GA";
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_TradelaneActivate _25: {
                    player.TradelaneActivate(_25.id,_25.left);
                    return true;
                }
                case ClientPacket_TradelaneDeactivate _26: {
                    player.TradelaneDeactivate(_26.id,_26.left);
                    return true;
                }
                case ClientPacket_ReceiveChatMessage _27: {
                    player.ReceiveChatMessage(_27.category,_27.player,_27.message);
                    return true;
                }
                case ClientPacket_PopupOpen _28: {
                    player.PopupOpen(_28.title,_28.contents,_28.id);
                    return true;
                }
                case ClientPacket_OnPlayerJoin _29: {
                    player.OnPlayerJoin(_29.id,_29.name);
                    return true;
                }
                case ClientPacket_OnPlayerLeave _30: {
                    player.OnPlayerLeave(_30.id,_30.name);
                    return true;
                }
            }
            return false;
