// AUTOGENERATED CODE
// Generated: 20210923 12:41:52 UTC
// Method count: 34
...
namespace LibreLancer.Net
{
    public interface IClientPlayer
    {
        ...
        void SpawnProjectiles(int owner, ProjectileSpawn[] projectiles);
    ...
    public partial class RemoteClientPlayer : IClientPlayer
    {
        ...
        public void SpawnProjectiles(int owner, ProjectileSpawn[] projectiles)
        {
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_SpawnProjectiles _5: {
                    player.SpawnProjectiles(_5.owner,_5.projectiles);
                    return true;
                }
