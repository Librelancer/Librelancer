// AUTOGENERATED CODE
// Generated: 20211004 16:18:51 UTC
// Method count: 37
    ...
    static class GeneratedProtocol
    {
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_SpawnProjectiles _5: {
                    player.SpawnProjectiles(_5.projectiles);
                    return true;
                }
                ...
                case ClientPacket_PopupOpen _19: {
                    player.PopupOpen(_19.title,_19.contents,_19.id);
                    return true;
                }
            }
            return false;
