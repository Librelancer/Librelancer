// AUTOGENERATED CODE
// Generated: 20220616 11:50:58 UTC
// Method count: 48
...
namespace LibreLancer.Net
{
    ...
    {
        public const string PROTOCOL_HASH = "s44Rn3Aj6+PHEDQ5BoD62g";
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_ReceiveChatMessage _24: {
                    player.ReceiveChatMessage(_24.category,_24.player,_24.message);
                    return true;
                }
                case ClientPacket_PopupOpen _25: {
                    player.PopupOpen(_25.title,_25.contents,_25.id);
                    return true;
                }
                case ClientPacket_OnPlayerJoin _26: {
                    player.OnPlayerJoin(_26.id,_26.name);
                    return true;
                }
                case ClientPacket_OnPlayerLeave _27: {
                    player.OnPlayerLeave(_27.id,_27.name);
                    return true;
                }
            }
            return false;
