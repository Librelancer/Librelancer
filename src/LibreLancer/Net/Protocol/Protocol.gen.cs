// AUTOGENERATED CODE
// Generated: 20211202 12:19:19 UTC
// Method count: 39
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_UpdateInventory _8: {
                    player.UpdateInventory(_8.credits,_8.ship);
                    return true;
                }
                ...
                case ClientPacket_SpawnDebris _11: {
                    player.SpawnDebris(_11.id,_11.archetype,_11.part,_11.position,_11.orientation,_11.mass);
                    return true;
                }
                case ClientPacket_BaseEnter _12: {
                    player.BaseEnter(_12._base,_12.credits,_12.ship,_12.rtcs,_12.news,_12.goods);
                    return true;
                }
                ...
                case ClientPacket_DespawnObject _14: {
                    player.DespawnObject(_14.id);
                    return true;
                }
                case ClientPacket_PlaySound _15: {
                    player.PlaySound(_15.sound);
                    return true;
                }
                case ClientPacket_PlayMusic _16: {
                    player.PlayMusic(_16.music);
                    return true;
                }
                case ClientPacket_DestroyPart _17: {
                    player.DestroyPart(_17.idtype,_17.id,_17.part);
                    return true;
                }
                case ClientPacket_RunMissionDialog _18: {
                    player.RunMissionDialog(_18.lines);
                    return true;
                }
                case ClientPacket_StartJumpTunnel _19: {
                    player.StartJumpTunnel();
                    return true;
                }
                case ClientPacket_PopupOpen _20: {
                    player.PopupOpen(_20.title,_20.contents,_20.id);
                    return true;
                }
            }
            return false;
