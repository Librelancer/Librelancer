// AUTOGENERATED CODE
// Generated: 20221121 11:40:29 UTC
// Method count: 61
...
namespace LibreLancer.Net
{
    ...
    public class ServerPacket_FireMissiles : IPacket
    {
    ...
    public class ClientPacket_UpdateSlotCount : IPacket
    {
        public int slot;
        public int count;
        public static object Read(PacketReader inPacket)
    ...
    public class ClientPacket_DeleteSlot : IPacket
    {
        public int slot;
        public static object Read(PacketReader inPacket)
        {
    ...
    public class ClientPacket_SpawnMissile : IPacket
    {
        public int id;
    ...
    public class ClientPacket_DestroyMissile : IPacket
    {
        public int id;
        public bool explode;
        public static object Read(PacketReader inPacket)
    ...
    {
        public const string PROTOCOL_HASH = "5wYJhhsOmy/HHyb/5+RIxQ";
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_EndTradelane _28: {
                    player.EndTradelane();
                    return true;
                }
                case ClientPacket_UpdateFormation _29: {
                    player.UpdateFormation(_29.formation);
                    return true;
                }
                case ClientPacket_TradelaneActivate _30: {
                    player.TradelaneActivate(_30.id,_30.left);
                    return true;
                }
                case ClientPacket_TradelaneDeactivate _31: {
                    player.TradelaneDeactivate(_31.id,_31.left);
                    return true;
                }
                case ClientPacket_MarkImportant _32: {
                    player.MarkImportant(_32.objId);
                    return true;
                }
                case ClientPacket_ReceiveChatMessage _33: {
                    player.ReceiveChatMessage(_33.category,_33.player,_33.message);
                    return true;
                }
                case ClientPacket_PopupOpen _34: {
                    player.PopupOpen(_34.title,_34.contents,_34.id);
                    return true;
                }
                case ClientPacket_OnPlayerJoin _35: {
                    player.OnPlayerJoin(_35.id,_35.name);
                    return true;
                }
                case ClientPacket_OnPlayerLeave _36: {
                    player.OnPlayerLeave(_36.id,_36.name);
                    return true;
                }
            }
            return false;
