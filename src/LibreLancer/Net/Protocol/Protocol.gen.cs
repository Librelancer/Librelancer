// AUTOGENERATED CODE
// Generated: 20210809 02:05:57 UTC
// Method count: 22
    ...
    static class GeneratedProtocol
    {
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_SpawnDebris _6: {
                    player.SpawnDebris(_6.id,_6.archetype,_6.part,_6.position,_6.orientation,_6.mass);
                    return true;
                }
                case ClientPacket_BaseEnter _7: {
                    player.BaseEnter(_7._base,_7.ship,_7.rtcs,_7.news,_7.goods);
                    return true;
                }
                case ClientPacket_UpdateRTCs _8: {
                    player.UpdateRTCs(_8.rtcs);
                    return true;
                }
                case ClientPacket_DespawnObject _9: {
                    player.DespawnObject(_9.id);
                    return true;
                }
                case ClientPacket_PlaySound _10: {
                    player.PlaySound(_10.sound);
                    return true;
                }
                case ClientPacket_PlayMusic _11: {
                    player.PlayMusic(_11.music);
                    return true;
                }
                case ClientPacket_DestroyPart _12: {
                    player.DestroyPart(_12.idtype,_12.id,_12.part);
                    return true;
                }
                case ClientPacket_RunMissionDialog _13: {
                    player.RunMissionDialog(_13.lines);
                    return true;
                }
            }
            return false;
