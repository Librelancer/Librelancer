// AUTOGENERATED CODE
// Generated: 20210919 06:17:42 UTC
// Method count: 29
    ...
    static class GeneratedProtocol
    {
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_StartAnimation _5: {
                    player.StartAnimation(_5.systemObject,_5.id,_5.anim);
                    return true;
                }
                case ClientPacket_UpdateInventory _6: {
                    player.UpdateInventory(_6.credits,_6.ship);
                    return true;
                }
                case ClientPacket_SpawnSolar _7: {
                    player.SpawnSolar(_7.solars);
                    return true;
                }
                case ClientPacket_OnConsoleMessage _8: {
                    player.OnConsoleMessage(_8.text);
                    return true;
                }
                case ClientPacket_SpawnDebris _9: {
                    player.SpawnDebris(_9.id,_9.archetype,_9.part,_9.position,_9.orientation,_9.mass);
                    return true;
                }
                case ClientPacket_BaseEnter _10: {
                    player.BaseEnter(_10._base,_10.credits,_10.ship,_10.rtcs,_10.news,_10.goods);
                    return true;
                }
                case ClientPacket_UpdateRTCs _11: {
                    player.UpdateRTCs(_11.rtcs);
                    return true;
                }
                case ClientPacket_DespawnObject _12: {
                    player.DespawnObject(_12.id);
                    return true;
                }
                case ClientPacket_PlaySound _13: {
                    player.PlaySound(_13.sound);
                    return true;
                }
                case ClientPacket_PlayMusic _14: {
                    player.PlayMusic(_14.music);
                    return true;
                }
                case ClientPacket_DestroyPart _15: {
                    player.DestroyPart(_15.idtype,_15.id,_15.part);
                    return true;
                }
                case ClientPacket_RunMissionDialog _16: {
                    player.RunMissionDialog(_16.lines);
                    return true;
                }
                case ClientPacket_StartJumpTunnel _17: {
