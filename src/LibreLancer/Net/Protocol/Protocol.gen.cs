// AUTOGENERATED CODE
// Generated: 20220304 03:05:25 UTC
// Method count: 43
    ...
    static class GeneratedProtocol
    {
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_Killed _15: {
                    player.Killed();
                    return true;
                }
                case ClientPacket_DespawnObject _16: {
                    player.DespawnObject(_16.id);
                    return true;
                }
                case ClientPacket_PlaySound _17: {
                    player.PlaySound(_17.sound);
                    return true;
                }
                case ClientPacket_PlayMusic _18: {
                    player.PlayMusic(_18.music);
                    return true;
                }
                case ClientPacket_DestroyPart _19: {
                    player.DestroyPart(_19.idtype,_19.id,_19.part);
                    return true;
                }
                case ClientPacket_RunMissionDialog _20: {
                    player.RunMissionDialog(_20.lines);
                    return true;
                }
                case ClientPacket_StartJumpTunnel _21: {
                    player.StartJumpTunnel();
                    return true;
                }
                case ClientPacket_PopupOpen _22: {
                    player.PopupOpen(_22.title,_22.contents,_22.id);
                    return true;
                }
            }
            return false;
