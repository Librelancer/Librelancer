// AUTOGENERATED CODE
// Generated: 20211206 09:47:34 UTC
// Method count: 40
...
namespace LibreLancer.Net
{
    ...
    public interface IServerPlayer
    {
        ...
        Task<bool> SellAttachedGood(string hardpoint);
    ...
    public partial class RemoteServerPlayer : IServerPlayer
    {
        ...
        public Task<bool> SellAttachedGood(string hardpoint)
        {
            var __SEQ = Interlocked.Increment(ref retSeq);
            var complete = ResponseHandler.GetCompletionSource_bool(__SEQ);
            SendPacket(new ServerPacket_SellAttachedGood() {
                Sequence = __SEQ,
                hardpoint = hardpoint,
            });
            return complete.Task;
    ...
    public class ServerPacket_SellAttachedGood : IPacket
    {
        public int Sequence;
        public string hardpoint;
        public static object Read(NetPacketReader message)
        {
            var _packet = new ServerPacket_SellAttachedGood();
            _packet.Sequence = message.GetInt();
    ...
    static class GeneratedProtocol
    {
        public static void RegisterPackets()
        {
            ...
            Packets.Register<ServerPacket_SellAttachedGood>(ServerPacket_SellAttachedGood.Read);
        ...
        public static async Task<bool> HandleServerPacket(IPacket pkt, IServerPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ServerPacket_SellAttachedGood _12: {
                    var retval = await player.SellAttachedGood(_12.hardpoint);
                    res.SendResponse(new ResponsePacket_bool() { Sequence = _12.Sequence, Value = retval });
                    return true;
                }
        ...
        public static async Task<bool> HandleClientPacket(IPacket pkt, IClientPlayer player, INetResponder res)
        {
            switch (pkt)
            {
                ...
                case ClientPacket_SpawnPlayer _5: {
                    player.SpawnPlayer(_5.system,_5.systime,_5.position,_5.orientation,_5.credits,_5.ship);
                    return true;
                }
                ...
                case ClientPacket_UpdateInventory _9: {
                    player.UpdateInventory(_9.credits,_9.ship);
                    return true;
                }
                ...
                case ClientPacket_BaseEnter _13: {
                    player.BaseEnter(_13._base,_13.credits,_13.ship,_13.rtcs,_13.news,_13.goods);
                    return true;
                }
