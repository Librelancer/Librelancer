...
namespace LibreLancer.Net.Protocol
{
    ...
    {
        public required List<NewCharFaction> Factions;
        public required List<NewCharPackage> Packages;
        public required List<NewCharPilot> Pilots;
    ...
    {
        public CharacterSelectInfo Info = null!;
        ...
        public static OpenCharacterListPacket Read(PacketReader message)
        {
            var oc = new OpenCharacterListPacket
            {
                ...
                {
                    ServerName = message.GetString()!,
                    ServerDescription = message.GetString()!,
                    ServerNews = message.GetString()!
                }
            };
            ...
            for (int i = 0; i < charCount; i++)
            {
                var c = new SelectableCharacter
                {
                    ...
                    Rank = (int) message.GetVariableUInt32(),
                    Funds = message.GetVariableInt64(),
                    Ship = message.GetString()!,
                    Location = message.GetString()!
                };
    ...
    {
        public SelectableCharacter Character = null!;
