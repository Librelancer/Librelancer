...
{
    public static readonly Vector4 Default_AxisX = new(0, 90, 180, 270);
    public static readonly Vector4 Default_AxisY = new(0, 90, 180, 270);
    public static readonly Vector4 Default_AxisZ = new(0, 90, 180, 270);
    ...
    private Vector4 axisx;
    private Vector4 axisy;
    private Vector4 axisz;
    ...
    private static float Angle(Vector4 v, int i) => MathHelper.DegreesToRadians(i switch
    {
        1 => v.Y,
        2 => v.Z,
        3 => v.W,
    ...
    public override bool Equals(object? obj)
    {
        ...
        return obj.GetType() == GetType() && Equals((AsteroidCubeRotation)obj);
    }
