...
public partial class Ship
{
    ...
    [Entry("camera_offset")] private Vector2 _cameraOffset;
    ...
    private void HandleHpType(Entry e) => HardpointTypes.Add(new ShipHpDef(e));

    [EntryHandler("surface_hit_effects", Multiline = true, MinComponents = 2)]
    private void HandleSurface(Entry e) => SurfaceHitEffects.Add(new SurfaceHitEffects(e));
