...
public class StateGraphDb
{
    ...
    public Dictionary<StateGraphDescription, StateGraph> Tables = new();

    private static bool TryParseFloats(string s, out float[] f)
    {
        var split = s.Split([' ', '\t'],
            ...
            while ((ln = reader.ReadLine()) != null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            Tables[currentDescription] = currentGraph ?? throw new InvalidOperationException($"Invalid state_graph");
                        }
