...
public class FreelancerData
{
    ...
    public AsteroidArchIni Asteroids = null!;
    public FontsIni Fonts = null!;
    public RichFontsIni RichFonts = null!;
    public NewsIni News = null!;
    public PetalDbIni PetalDb = null!;
    public HudIni Hud = null!;
    public BaseNavBarIni BaseNavBar = null!;
    public MBasesIni? MBases;
    public NewCharDBIni NewCharDB = null!;
    public ContentDll ContentDll = null!;
    public InfocardMapIni InfocardMap = null!;
    public InitialWorldIni InitialWorld = null!;
    ...
    public SpecificNPCIni SpecificNPCs = null!;
