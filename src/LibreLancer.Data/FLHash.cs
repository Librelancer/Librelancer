...
{
    private const int CRC16IBM_POLYNOMIAL = 0xA001;
    private const ushort CCITT_POLYNOMIAL = 0x1021;
    private const int NUM_BITS = 8;
    private const int HASH_TABLE_SIZE = (1 << NUM_BITS);

    private static uint[] modded_crc16_ibm_table;
    private static ushort[] fachash_table;
    static FLHash()
    {
