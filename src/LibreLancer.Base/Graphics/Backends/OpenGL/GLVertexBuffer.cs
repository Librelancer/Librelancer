...
internal class GLVertexBuffer : IVertexBuffer
{
    ...
    private void Create(int length, bool isStream)
    {
    ...
    public IntPtr BeginStreaming()
    {
        ...
        return (IntPtr)(buffer ?? throw new InvalidOperationException("Buffer was not initialized"));
    }
    ...
    public void EndStreaming(int count)
    {
        if (!streaming)
        {
            throw new InvalidOperationException("not streaming buffer");
        }
        ...
        GL.BufferSubData(GL.GL_ARRAY_BUFFER, IntPtr.Zero, (IntPtr) (count * decl.Stride), (IntPtr)(buffer ?? throw new InvalidOperationException("Buffer was not initalized")));
    }
    ...
    private void SetPointers(int baseVertex)
    {
    ...
    {
        if (glElements is null)
        {
            throw new InvalidOperationException("Elements buffer was not initialized");
        }
