...
public struct VertexPositionNormalDiffuseTexture(Vector3 pos, Vector3 normal, VertexDiffuse diffuse, Vector2 texcoord)
    : IVertexType
{
    public Vector3 Position = pos;
    public Vector3 Normal = normal;
    public VertexDiffuse Diffuse = diffuse;
    ...
    public override bool Equals(object? obj) => obj is VertexPositionNormalDiffuseTexture other && other == this;
