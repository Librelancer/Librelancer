...
internal class BlurgEngine : RichTextEngine
{
    ...
    private class BlurgBuiltText : BuiltRichText
    {
    ...
    private void DrawResult(BlurgResult r, int x, int y)
    {
