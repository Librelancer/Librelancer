...
internal class Win32Platform : IPlatform
{
    ...
    private static bool GdiOpenFace(string face, out byte[]? buffer)
    {
    ...
    {
        if (GdiOpenFace("Consolas", out var buffer)) return buffer;
    ...
    private class Win32Events : PlatformEvents
    {
