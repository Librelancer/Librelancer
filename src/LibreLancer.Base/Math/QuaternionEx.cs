...
public class QuaternionEx
{
    ...
    public static Quaternion LookRotation(Vector3 forward, Vector3 up)
    {
        ...
        if (trace > 0f)
        {
            var s = 0.5f / (float)System.Math.Sqrt(trace + 1f);
            q.W = 0.25f / s;
            q.X = (m12 - m21) * s;
            q.Y = (m20 - m02) * s;
            q.Z = (m01 - m10) * s;
        ...
        else
        {
            if ((m00 >= m11) && (m00 >= m22))
            {
                var s = 2f * (float)System.Math.Sqrt(1f + m00 - m11 - m22);
                q.X = 0.25f * s;
                q.Y = (m01 + m10) / s;
                q.Z = (m02 + m20) / s;
                q.W = (m12 - m21) / s;
            ...
            {
                var s = 2 * (float)System.Math.Sqrt(1f + m11 - m00 - m22);
                q.X = (m10 + m01) / s;
                q.Y = 0.25f * s;
                q.Z = (m21 + m12) / s;
                q.W = (m20 - m02) / s;
            ...
            {
                var s = 2 * (float)System.Math.Sqrt(1f + m22 - m00 - m11);
                q.X = (m20 + m02) / s;
                q.Y = (m21 + m12) / s;
                q.Z = 0.25f * s;
                q.W = (m01 - m10) / s;
