...
public class OptionsScreen(MainWindow win, GameConfig config, ScreenManager screens, PopupManager popups)
    : Screen(screens, popups)
{
    private static readonly float LABEL_WIDTH = 135f;
    private static readonly float BUTTON_WIDTH = 110f;
    private static readonly float BACK_BUTTON_HEIGHT = 45f;
    ...
    private void DrawGraphicsSettings()
    {
        ...
        ref var heightInput = ref heightBuffer;
    ...
    private static void SoundSlider(string text, ref float flt)
    {
        ImGui.PushID(text);
        ImGui.AlignTextToFramePadding();
        ImGui.Text(text);
