...
namespace LibreLancer.Jitter.Collision
{
    ...
    public sealed class GJKCollide
    {
        ...
        private static void SupportMapTransformed(ISupportMappable support, ref Matrix3 orientation, ref Vector3 position, ref Vector3 direction, out Vector3 result)
        {
        ...
        public static bool Pointcast(ISupportMappable support, ref Matrix3 orientation,ref Vector3 position,ref Vector3 point)
        {
    ...
    //    }
        ...
        public static bool Raycast(ISupportMappable support, ref Matrix3 orientation, ref Matrix3 invOrientation,
