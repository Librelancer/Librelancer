...
public sealed class ActNagDistTowards : NodeTriggerEntry
{
    ...
    class SetObjectAction(ActNagDistTowards node) : EditorAction
    {
    ...
    class SetPointAction(ActNagDistTowards node) : EditorAction
    {
        public override void Commit()
        {
        ...
        ref NodeLookups lookups)
    {
        ...
        Controls.IdsInputStringUndo("Mission Fail IDS", gameData, popup, undoBuffer, () => ref Data.MissionFailIds);
