...
public class TestSaveGameList : ITableData
{
    ...
    private static string FlTime(DateTime time)
    {
...
public class FakeContactList : IContactListData
{
    ...
    [WattleScriptHidden] public int SelectedIndex => selIndex;
...
public class TestingApi
{
    ...
    private static readonly NavbarButtonInfo cityscape = new NavbarButtonInfo("IDS_HOTSPOT_EXIT", "Cityscape");
    private static readonly NavbarButtonInfo bar = new NavbarButtonInfo("IDS_HOTSPOT_BAR", "Bar");

    private static readonly NavbarButtonInfo
        trader = new NavbarButtonInfo("IDS_HOTSPOT_COMMODITYTRADER_ROOM", "Trader");

    private static readonly NavbarButtonInfo equip =
        new NavbarButtonInfo("IDS_HOTSPOT_EQUIPMENTDEALER_ROOM", "Equipment");

    private static readonly NavbarButtonInfo shipDealer =
        new NavbarButtonInfo("IDS_HOTSPOT_SHIPDEALER_ROOM", "ShipDealer");
    ...
    private TestServerList serverList = new TestServerList();
    ...
    [WattleScriptHidden] public bool Multiplayer = false;
    ...
    public Infocard _ScannedInfocard = null!;
