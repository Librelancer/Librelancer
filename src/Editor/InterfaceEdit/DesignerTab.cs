...
public class DesignerTab : SaveableTab
{
    ...
    public DesignerTab(string text, string path, MainWindow mainWindow)
    {
        ...
        {
            CommandBuffer = mainWindow.CommandBuffer,
            RenderContext = mainWindow.RenderContext,
            Lines = mainWindow.LineRenderer,
            GameApi = mainWindow.TestApi
        };
    ...
    private object FindEditingObject(int line, int column)
    {
        bool first = true;
        object? obj = null;
    ...
    public override void Draw(double elapsed)
    {
        ...
        if (TabHandler.VerticalTab(Icons.PenSquare, "Properties", VerticalTabStyle.IconAndText, propertiesOpen))
    ...
    private void DoViewport(double delta)
    {
    ...
    private string ReplaceXml(string text, string newElement)
    {
    ...
    private int GetIndex(string text, int line, int column)
    {
        int cLine = 1;
        int index = 0;
    ...
    private int GetStart(string text)
    {
