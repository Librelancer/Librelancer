...
public class ImportedModel
{
    ...
    public EditResult<EditableUtf> CreateModel(ModelImporterSettings settings)
    {
        ...
        if (settings.GenerateMaterials)
        {
            ...
            MaterialImporter.GenerateResourceLibraries(materials, Images, utf.Root,
                warnings,
                settings.GeneratePlaceholderTextures,
                settings.ImportTextures,
                settings.AdvancedMaterials,
