...
internal sealed class StaticObject : PhysicsObject
{
    ...
    {
        get => world.CollidableObjects[BepuObject.Handle] == CollisionKind.StaticBody;
        set => world.CollidableObjects[BepuObject.Handle] = value ? CollisionKind.StaticBody : CollisionKind.NoCollision;
    }
